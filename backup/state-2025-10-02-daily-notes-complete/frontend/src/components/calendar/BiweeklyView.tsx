...
const BiweeklyView: React.FC<BiweeklyViewProps> = ({
  ...
  const loadCalendarData = async () => {
    ...
    try {
      ...
      console.error('Error loading biweekly view data:', err);
    } finally {
      setIsLoading(false);
    }
  };
  ...
  const handleViewTypeChange = (viewType: CalendarViewType) => {
    // For biweekly view, we don't change the view type, but we could trigger navigation
            ...
            <div style={{
              ...
              {isLoading ? (
                <div style={{
                  ...
                  <div>Loading bi-weekly schedule...</div>
                </div>
              ) : (
